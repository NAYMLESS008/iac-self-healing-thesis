...
def main():
    ...
    detection = run_step(
        ...
        [
            sys.executable,
            "-m",
            "controller.wazuh_ssh_public_key_alert_check",
        ],
    )
    ...
    evidence = run_step(
        ...
        [
            sys.executable,
            "-m",
            "controller.capture_ssh_public_key_evidence",
        ],
    )
    ...
    validation = run_step(
        ...
        [
            sys.executable,
            "-m",
            "controller.validate_ssh_public_key_recovery",
        ],
    )
    ...
    print(
        "\n[SUCCESS] Full unauthorized SSH public-key "
